      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            // var minSrc = 'https://imc-img.oss-cn-hangzhou.aliyuncs.com/min_photos/' + data.link[i];
            // var src = 'https://imc-img.oss-cn-hangzhou.aliyuncs.com/photos/' + data.link[i];
            // var minSrc = 'https://imc-img.iamlj.com/min_photos/' + data.link[i];
            // var src = 'https://imc-img.iamlj.com/photos/' + data.link[i];
            var minSrc = 'http://imc-file.iamlj.com/min_photos/' + data.link[i];
            var src = 'http://imc-file.iamlj.com/photos/' + data.link[i];
